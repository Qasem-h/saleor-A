...
export const blue = "#04ccff";
export const blueDark = "#2e1690";
export const blueLight = "#e9e9e9";
...
export const grayDark = "#707070";
export const grayLight = "#f1f5f5";
export const green = "#3ed2a0";
export const overlayColor = "rgba(199, 207, 207, 0.8)";
export const rose = "#fd222e";
export const turquoise = "#7ec8ef";
export const turquoiseDark = "#359889";
